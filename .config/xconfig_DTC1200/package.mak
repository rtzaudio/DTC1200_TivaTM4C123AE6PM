...
override PKGDIR = xconfig_DTC1200
...
package/%.xdc.inc package/%_xconfig_DTC1200.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_DTC1200" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: DTC1200.pem4f

-include package/cfg/DTC1200_pem4f.mak
-include package/cfg/DTC1200_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/DTC1200_pem4f.dep
endif
DTC1200.pem4f: package/cfg/DTC1200_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
DTC1200.pem4f package/cfg/DTC1200_pem4f.c: .libraries,em4f
endif

package/cfg/DTC1200_pem4f.c package/cfg/DTC1200_pem4f.h package/cfg/DTC1200_pem4f.xdl: override _PROG_NAME := DTC1200.xem4f
package/cfg/DTC1200_pem4f.c: package/cfg/DTC1200_pem4f.cfg
package/cfg/DTC1200_pem4f.xdc.inc: package/cfg/DTC1200_pem4f.xdl
package/cfg/DTC1200_pem4f.xdl package/cfg/DTC1200_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/DTC1200_pem4f.cfg
	-$(RM) package/cfg/DTC1200_pem4f.dep
	-$(RM) package/cfg/DTC1200_pem4f.c
	-$(RM) package/cfg/DTC1200_pem4f.xdc.inc

clean,em4f::
	-$(RM) DTC1200.pem4f
.executables,em4f .executables: DTC1200.xem4f

DTC1200.xem4f: |DTC1200.pem4f

-include package/cfg/DTC1200.xem4f.mak
DTC1200.xem4f: package/cfg/DTC1200_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/DTC1200_pem4f.oem4f   package/cfg/DTC1200_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
DTC1200.xem4f: export C_DIR=
DTC1200.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
DTC1200.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

DTC1200.test test,em4f test: DTC1200.xem4f.test

DTC1200.xem4f.test:: DTC1200.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 DTC1200.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.DTC1200.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,DTC1200.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
DTC1200_pem4f.oem4f,copy : package/cfg/DTC1200_pem4f.oem4f
DTC1200_pem4f.sem4f,copy : package/cfg/DTC1200_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_DTC1200
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_DTC1200.tar.dep
endif
package/rel/xconfig_DTC1200/xconfig_DTC1200/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_DTC1200/xconfig_DTC1200/package/package.rel.xml: package/build.cfg
package/rel/xconfig_DTC1200/xconfig_DTC1200/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_DTC1200/xconfig_DTC1200/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_DTC1200.tar: package/rel/xconfig_DTC1200.xdc.inc package/rel/xconfig_DTC1200/xconfig_DTC1200/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_DTC1200.xdc.inc,package/rel/xconfig_DTC1200.tar.dep)


release release,xconfig_DTC1200: all xconfig_DTC1200.tar
clean:: .clean
	-$(RM) xconfig_DTC1200.tar
	-$(RM) package/rel/xconfig_DTC1200.xdc.inc
	-$(RM) package/rel/xconfig_DTC1200.tar.dep
