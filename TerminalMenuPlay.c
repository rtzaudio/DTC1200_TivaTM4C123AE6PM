...
{ 5, 2,  "1",  "Boost Time ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 2048,
		NULL, put_idata, DT_LONG, &g_sys.play_lo_boost_time },

{ 6, 2,  "2",  "Boost Step ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 5,
		NULL, put_idata, DT_LONG, &g_sys.play_lo_boost_step },

{ 7, 2,  "3",  "Boost Start", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = DAC_MAX,
		NULL, put_idata, DT_LONG, &g_sys.play_lo_boost_start },

{ 8, 2,  "4",  "Boost End  ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = DAC_MAX,
...
{ 5, 34, "5",  "Boost Time ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 10000,
		NULL, put_idata, DT_LONG, &g_sys.play_hi_boost_time },

{ 6, 34, "6",  "Boost Step ", MI_NUMERIC,
		.param1.U = 1,
		.param2.U = 100,
		NULL, put_idata, DT_LONG, &g_sys.play_hi_boost_step },

{ 7, 34, "7",  "Boost Start", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = DAC_MAX,
		NULL, put_idata, DT_LONG, &g_sys.play_hi_boost_start },

{ 8, 34, "8",  "Boost End  ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = DAC_MAX,
