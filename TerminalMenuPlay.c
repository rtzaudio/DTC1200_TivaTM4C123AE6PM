...
{ 14, 2, "10", "Play Tension Velocity Gain   ", MI_NUMERIC,
		.param1.U = 1,
		.param2.U = 24,
		NULL, set_idata, DT_LONG, &g_sys.play_tension_gain },

{ 15, 2, "11", "Pinch Roller Settling Time   ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 1000,
		NULL, set_idata, DT_LONG, &g_sys.pinch_settle_time },

{ 16, 2, "12", "Shuttle to Play Settling Time", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 1000,
		NULL, set_idata, DT_LONG, &g_sys.play_settle_time },

{ 17, 2, "13", "Brake Settle Time            ", MI_NUMERIC,
		.param1.U = 0,
		.param2.U = 2000,
